...
<head>
    ...
    @php
        ...
        $terms        = \App\Models\SystemSetting::get('invoice.terms', '');
        $returnPolicy = \App\Models\SystemSetting::get('invoice.return_policy', '');
        $warranty     = \App\Models\SystemSetting::get('invoice.warranty', '');
