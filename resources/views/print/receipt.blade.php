...
@php
    ...
    $primaryColor = '#1e40af';
    $lightBorder  = '#bfdbfe';
    $docLabel     = 'سند قبض — ' . $receipt->receipt_number;
@endphp

@section('title', $docLabel)
@section('toolbar-title', $docLabel . ($receipt->customer ? ' | ' . $receipt->customer->name : ''))
...
@section('content')
    ...
    <table class="info-table">
        <tr>
            <td>رقم السند</td>
            <td><span class="info-ref">{{ $receipt->receipt_number }}</span></td>
        </tr>
        <tr>
            <td>التاريخ</td>
        ...
        <tr>
            ...
            <td>{{ $receipt->businessUnit?->name }}</td>
        </tr>
        @if($receipt->invoice)
        <tr>
            <td>الفاتورة المسددة</td>
            <td>{{ $receipt->invoice->reference_number }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{ $receipt->journalEntry->entry_number }}</td>
        </tr>
        @endif
    ...
    <div class="sig-wrap">
        <div class="sig-cell">
            <div class="sig-line">المُحصِّل</div>
        </div>
        <div class="sig-cell">
