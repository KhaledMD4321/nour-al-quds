...
@php
    ...
    if ($isQuotation)   $docLabel = 'عرض سعر — ' . $invoice->reference_number;
    elseif ($isSaleReturn) $docLabel = 'مرتجع — ' . $invoice->reference_number;
    else                $docLabel = 'فاتورة — ' . $invoice->reference_number;
@endphp

@section('title', $docLabel)
@section('toolbar-title', $docLabel . ($invoice->customer ? ' | ' . $invoice->customer->name : ''))
...
<style>
    ...
    .company-name { font-size: 19px; font-weight: 800; color: {{ $headerColor }}; margin-bottom: 4px; }
    ...
    .terms-title { font-weight: 700; color: #374151; margin-bottom: 2px; }
    ...
    <div class="info-section">
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                <span style="font-weight:800; color:{{ $headerColor }};">{{ $invoice->reference_number }}</span>
            </div>
