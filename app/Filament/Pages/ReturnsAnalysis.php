...
class ReturnsAnalysis extends Page
{
    ...
    protected static ?string $title = 'تحليل المرتجعات';

    protected static ?string $navigationLabel = 'تحليل المرتجعات';

    protected string $view = 'filament.pages.returns-analysis';
    ...
    {
        return app(ReturnsAnalysisService::class)->summary(
            $this->from_date ?? today()->startOfMonth()->toDateString(),
            $this->to_date ?? today()->toDateString(),
    ...
    {
        return app(ReturnsAnalysisService::class)->byProduct(
            $this->from_date ?? today()->startOfMonth()->toDateString(),
            $this->to_date ?? today()->toDateString(),
            $this->business_unit_id ?: null,
        );
    ...
    {
        return app(ReturnsAnalysisService::class)->monthlyTrend(6, $this->business_unit_id ?: null);
    }
}
